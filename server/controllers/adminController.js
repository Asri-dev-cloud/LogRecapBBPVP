 ...
 * Updates user's role: 'admin' or 'user' (admin only).
 */
 ...
 * Deletes user's account completely (admin only).
 */
...
/**
 * GET /api/admin/logs
 * Returns backend activity logs for Super Admin panel.
 */
 ...
 * Updates details of an existing user (admin only).
 */
