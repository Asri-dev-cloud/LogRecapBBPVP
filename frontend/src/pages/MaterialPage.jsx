  ...
  return (
    <PageTransition className="pb-16">
      <section className="mx-auto w-full max-w-7xl px-4 sm:px-6">
        <div className="relative overflow-hidden rounded-[2rem] border border-zinc-200/50 bg-white/70 px-5 py-12 shadow-xl shadow-zinc-900/5 backdrop-blur dark:border-white/[0.04] dark:bg-[#090b0f]/75 sm:px-8 lg:px-12">
          ...
          <div className="mx-auto mt-10 flex max-w-5xl flex-wrap justify-center gap-4">
            {material.overview.map((item, idx) => {
              ...
              return (
                <div key={item} className="group relative w-full max-w-[15rem] flex-1 basis-56 overflow-hidden rounded-3xl border border-zinc-200/40 bg-white/75 p-5 shadow-sm backdrop-blur transition-all duration-300 hover:-translate-y-1 hover:border-zinc-300 hover:shadow-lg dark:border-white/[0.03] dark:bg-zinc-950/20 dark:hover:border-white/[0.1]">
                  <span aria-hidden="true" className="pointer-events-none absolute -right-3 -top-5 select-none text-7xl font-black text-zinc-100 transition-colors duration-300 group-hover:text-zinc-200 dark:text-white/[0.02] dark:group-hover:text-white/[0.04]">
