      ...
      <div className="mx-auto w-full max-w-7xl px-4 sm:px-6">
        ...
        >
          ...
          >
            ...
            <span className="hidden text-xs font-black sm:block">Home</span>
          </Link>

          {/* Desktop topics */}
          <div 
            className="hidden min-w-0 flex-1 items-center justify-start gap-1 overflow-x-auto px-4 lg:flex whitespace-nowrap scroll-smooth no-scrollbar"
          ...
          <div className="ml-auto flex items-center gap-1">
            ...
            <NavLink to="/live-quiz" className={iconBtn} title="Live Quiz (Multiplayer)">
              <Gamepad2 size={17} />
            </NavLink>
